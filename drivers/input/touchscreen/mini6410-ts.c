...
static inline void notify_data(unsigned x, unsigned y, unsigned down)
{
...
static int s3c_ts_read(struct file *filp, char __user *buff, size_t count, loff_t *offp)
{
    ...
    err = copy_to_user((void *)buff, (const void *)(&ts_status), sizeof ts_status);
